...
class disort_flag(_object):
    ...
    if _newclass:
        brdf_type = _swig_property(_cdisort.disort_flag_brdf_type_get, _cdisort.disort_flag_brdf_type_set)
    __swig_setmethods__["quiet"] = _cdisort.disort_flag_quiet_set
    __swig_getmethods__["quiet"] = _cdisort.disort_flag_quiet_get
    if _newclass:
        quiet = _swig_property(_cdisort.disort_flag_quiet_get, _cdisort.disort_flag_quiet_set)
    ...
    if _newclass:
        intensity_correction = _swig_property(_cdisort.disort_flag_intensity_correction_get, _cdisort.disort_flag_intensity_correction_set)
    ...
    if _newclass:
        old_intensity_correction = _swig_property(_cdisort.disort_flag_old_intensity_correction_get, _cdisort.disort_flag_old_intensity_correction_set)
...
class disort_radiant(_object):
    ...
    if _newclass:
        uavgdn = _swig_property(_cdisort.disort_radiant_uavgdn_get, _cdisort.disort_radiant_uavgdn_set)
    ...
    if _newclass:
        uavgup = _swig_property(_cdisort.disort_radiant_uavgup_get, _cdisort.disort_radiant_uavgup_set)
    ...
    if _newclass:
        uavgso = _swig_property(_cdisort.disort_radiant_uavgso_get, _cdisort.disort_radiant_uavgso_set)
...
class ambrals_brdf_spec(_object):
    ...
    if _newclass:
        iso = _swig_property(_cdisort.ambrals_brdf_spec_iso_get, _cdisort.ambrals_brdf_spec_iso_set)
    __swig_setmethods__["vol"] = _cdisort.ambrals_brdf_spec_vol_set
    __swig_getmethods__["vol"] = _cdisort.ambrals_brdf_spec_vol_get
    if _newclass:
        vol = _swig_property(_cdisort.ambrals_brdf_spec_vol_get, _cdisort.ambrals_brdf_spec_vol_set)
    __swig_setmethods__["geo"] = _cdisort.ambrals_brdf_spec_geo_set
    __swig_getmethods__["geo"] = _cdisort.ambrals_brdf_spec_geo_get
    if _newclass:
        geo = _swig_property(_cdisort.ambrals_brdf_spec_geo_get, _cdisort.ambrals_brdf_spec_geo_set)
...
class cam_brdf_spec(_object):
    ...
    if _newclass:
        u10 = _swig_property(_cdisort.cam_brdf_spec_u10_get, _cdisort.cam_brdf_spec_u10_set)
    __swig_setmethods__["pcl"] = _cdisort.cam_brdf_spec_pcl_set
    __swig_getmethods__["pcl"] = _cdisort.cam_brdf_spec_pcl_get
    if _newclass:
        pcl = _swig_property(_cdisort.cam_brdf_spec_pcl_get, _cdisort.cam_brdf_spec_pcl_set)
    __swig_setmethods__["xsal"] = _cdisort.cam_brdf_spec_xsal_set
    __swig_getmethods__["xsal"] = _cdisort.cam_brdf_spec_xsal_get
    if _newclass:
        xsal = _swig_property(_cdisort.cam_brdf_spec_xsal_get, _cdisort.cam_brdf_spec_xsal_set)
...
class disort_brdf(_object):
    ...
    if _newclass:
        rpv = _swig_property(_cdisort.disort_brdf_rpv_get, _cdisort.disort_brdf_rpv_set)
...
class disort_state(_object):
    ...
    if _newclass:
        mu_phase = _swig_property(_cdisort.disort_state_mu_phase_get, _cdisort.disort_state_mu_phase_set)
    __swig_setmethods__["phase"] = _cdisort.disort_state_phase_set
    __swig_getmethods__["phase"] = _cdisort.disort_state_phase_get
    if _newclass:
        phase = _swig_property(_cdisort.disort_state_phase_get, _cdisort.disort_state_phase_set)
...
class disort_pair(_object):
    ...
    if _newclass:
        zero = _swig_property(_cdisort.disort_pair_zero_get, _cdisort.disort_pair_zero_set)
    __swig_setmethods__["one"] = _cdisort.disort_pair_one_set
    __swig_getmethods__["one"] = _cdisort.disort_pair_one_get
    if _newclass:
        one = _swig_property(_cdisort.disort_pair_one_get, _cdisort.disort_pair_one_set)
...
class disort_triplet(_object):
    ...
    if _newclass:
        zero = _swig_property(_cdisort.disort_triplet_zero_get, _cdisort.disort_triplet_zero_set)
    __swig_setmethods__["one"] = _cdisort.disort_triplet_one_set
    __swig_getmethods__["one"] = _cdisort.disort_triplet_one_get
    if _newclass:
        one = _swig_property(_cdisort.disort_triplet_one_get, _cdisort.disort_triplet_one_set)
    __swig_setmethods__["alpha"] = _cdisort.disort_triplet_alpha_set
    __swig_getmethods__["alpha"] = _cdisort.disort_triplet_alpha_get
    if _newclass:
        alpha = _swig_property(_cdisort.disort_triplet_alpha_get, _cdisort.disort_triplet_alpha_set)
...
_cdisort.TWOSTR_NERR_swigconstant(_cdisort)
...
class twostr_diag(_object):
    ...
    if _newclass:
        super = _swig_property(_cdisort.twostr_diag_super_get, _cdisort.twostr_diag_super_set)
    __swig_setmethods__["on"] = _cdisort.twostr_diag_on_set
    __swig_getmethods__["on"] = _cdisort.twostr_diag_on_get
    if _newclass:
        on = _swig_property(_cdisort.twostr_diag_on_get, _cdisort.twostr_diag_on_set)
    __swig_setmethods__["sub"] = _cdisort.twostr_diag_sub_set
    __swig_getmethods__["sub"] = _cdisort.twostr_diag_sub_get
    if _newclass:
        sub = _swig_property(_cdisort.twostr_diag_sub_get, _cdisort.twostr_diag_sub_set)
...
_cdisort.TRUE_swigconstant(_cdisort)
TRUE = _cdisort.TRUE

_cdisort.FALSE_swigconstant(_cdisort)
FALSE = _cdisort.FALSE

_cdisort.FIRST_IPHAS_swigconstant(_cdisort)
FIRST_IPHAS = _cdisort.FIRST_IPHAS

_cdisort.ISOTROPIC_swigconstant(_cdisort)
ISOTROPIC = _cdisort.ISOTROPIC

_cdisort.RAYLEIGH_swigconstant(_cdisort)
RAYLEIGH = _cdisort.RAYLEIGH

_cdisort.HENYEY_GREENSTEIN_swigconstant(_cdisort)
HENYEY_GREENSTEIN = _cdisort.HENYEY_GREENSTEIN

_cdisort.HAZE_GARCIA_SIEWERT_swigconstant(_cdisort)
HAZE_GARCIA_SIEWERT = _cdisort.HAZE_GARCIA_SIEWERT

_cdisort.CLOUD_GARCIA_SIEWERT_swigconstant(_cdisort)
CLOUD_GARCIA_SIEWERT = _cdisort.CLOUD_GARCIA_SIEWERT

_cdisort.LAST_IPHAS_swigconstant(_cdisort)
LAST_IPHAS = _cdisort.LAST_IPHAS

_cdisort.GENERAL_BC_swigconstant(_cdisort)
GENERAL_BC = _cdisort.GENERAL_BC

_cdisort.SPECIAL_BC_swigconstant(_cdisort)
SPECIAL_BC = _cdisort.SPECIAL_BC

_cdisort.TOP_ILLUM_swigconstant(_cdisort)
TOP_ILLUM = _cdisort.TOP_ILLUM

_cdisort.BOT_ILLUM_swigconstant(_cdisort)
BOT_ILLUM = _cdisort.BOT_ILLUM

_cdisort.DS_WARNING_swigconstant(_cdisort)
DS_WARNING = _cdisort.DS_WARNING

_cdisort.DS_ERROR_swigconstant(_cdisort)
DS_ERROR = _cdisort.DS_ERROR

_cdisort.VERBOSE_swigconstant(_cdisort)
VERBOSE = _cdisort.VERBOSE

_cdisort.QUIET_swigconstant(_cdisort)
QUIET = _cdisort.QUIET

_cdisort.BRDF_NONE_swigconstant(_cdisort)
BRDF_NONE = _cdisort.BRDF_NONE

_cdisort.BRDF_RPV_swigconstant(_cdisort)
BRDF_RPV = _cdisort.BRDF_RPV

_cdisort.BRDF_CAM_swigconstant(_cdisort)
BRDF_CAM = _cdisort.BRDF_CAM

_cdisort.BRDF_AMB_swigconstant(_cdisort)
BRDF_AMB = _cdisort.BRDF_AMB

_cdisort.BRDF_HAPKE_swigconstant(_cdisort)
BRDF_HAPKE = _cdisort.BRDF_HAPKE

_cdisort.NMUG_swigconstant(_cdisort)
NMUG = _cdisort.NMUG

_cdisort.M_E_swigconstant(_cdisort)
M_E = _cdisort.M_E

_cdisort.M_LOG2E_swigconstant(_cdisort)
M_LOG2E = _cdisort.M_LOG2E

_cdisort.M_LOG10E_swigconstant(_cdisort)
M_LOG10E = _cdisort.M_LOG10E

_cdisort.M_LN2_swigconstant(_cdisort)
M_LN2 = _cdisort.M_LN2

_cdisort.M_LN10_swigconstant(_cdisort)
M_LN10 = _cdisort.M_LN10

_cdisort.M_PI_swigconstant(_cdisort)
M_PI = _cdisort.M_PI

_cdisort.M_PI_2_swigconstant(_cdisort)
M_PI_2 = _cdisort.M_PI_2

_cdisort.M_PI_4_swigconstant(_cdisort)
M_PI_4 = _cdisort.M_PI_4

_cdisort.M_1_PI_swigconstant(_cdisort)
M_1_PI = _cdisort.M_1_PI

_cdisort.M_2_PI_swigconstant(_cdisort)
M_2_PI = _cdisort.M_2_PI

_cdisort.M_2_SQRTPI_swigconstant(_cdisort)
M_2_SQRTPI = _cdisort.M_2_SQRTPI

_cdisort.M_SQRT2_swigconstant(_cdisort)
M_SQRT2 = _cdisort.M_SQRT2

_cdisort.M_SQRT1_2_swigconstant(_cdisort)
M_SQRT1_2 = _cdisort.M_SQRT1_2

_cdisort.DEG_swigconstant(_cdisort)
DEG = _cdisort.DEG

def c_disort(ds, out):
    return _cdisort.c_disort(ds, out)
c_disort = _cdisort.c_disort

def c_bidir_reflectivity(wvnmlo, wvnmhi, mu, mup, dphi, brdf_type, brdf, callnum):
    return _cdisort.c_bidir_reflectivity(wvnmlo, wvnmhi, mu, mup, dphi, brdf_type, brdf, callnum)
c_bidir_reflectivity = _cdisort.c_bidir_reflectivity

def c_bidir_reflectivity_hapke(wvnmlo, wvnmhi, mu, mup, dphi):
    return _cdisort.c_bidir_reflectivity_hapke(wvnmlo, wvnmhi, mu, mup, dphi)
c_bidir_reflectivity_hapke = _cdisort.c_bidir_reflectivity_hapke

def c_bidir_reflectivity_rpv(brdf, mu1, mu2, phi, badmu):
    return _cdisort.c_bidir_reflectivity_rpv(brdf, mu1, mu2, phi, badmu)
c_bidir_reflectivity_rpv = _cdisort.c_bidir_reflectivity_rpv

def c_dref(wvnmlo, wvnmhi, mu, brdf_type, brdf, callnum):
    return _cdisort.c_dref(wvnmlo, wvnmhi, mu, brdf_type, brdf, callnum)
c_dref = _cdisort.c_dref

def c_getmom(iphas, gg, nmom, pmom):
    return _cdisort.c_getmom(iphas, gg, nmom, pmom)
c_getmom = _cdisort.c_getmom

def c_asymmetric_matrix(aa, evec, eval, m, ia, ievec, ier, wk):
    return _cdisort.c_asymmetric_matrix(aa, evec, eval, m, ia, ievec, ier, wk)
c_asymmetric_matrix = _cdisort.c_asymmetric_matrix

def c_intensity_components(ds, gc, kk, layru, ll, lyrcut, mazim, ncut, nn, taucpr, utaupr, zz, plk, uum):
    return _cdisort.c_intensity_components(ds, gc, kk, layru, ll, lyrcut, mazim, ncut, nn, taucpr, utaupr, zz, plk, uum)
c_intensity_components = _cdisort.c_intensity_components

def c_fluxes(ds, out, ch, cmu, cwt, gc, kk, layru, ll, lyrcut, ncut, nn, prntu0, taucpr, utaupr, xr, zbeamsp, zbeama, zz, plk, fl, u0c):
    return _cdisort.c_fluxes(ds, out, ch, cmu, cwt, gc, kk, layru, ll, lyrcut, ncut, nn, prntu0, taucpr, utaupr, xr, zbeamsp, zbeama, zz, plk, fl, u0c)
c_fluxes = _cdisort.c_fluxes

def c_intensity_correction(ds, out, dither, flyr, layru, lyrcut, ncut, oprim, phasa, phast, phasm, phirad, tauc, taucpr, utaupr):
    return _cdisort.c_intensity_correction(ds, out, dither, flyr, layru, lyrcut, ncut, oprim, phasa, phast, phasm, phirad, tauc, taucpr, utaupr)
c_intensity_correction = _cdisort.c_intensity_correction

def c_new_intensity_correction(ds, out, dither, flyr, layru, lyrcut, ncut, oprim, phasa, phast, phasm, phirad, tauc, taucpr, utaupr):
    return _cdisort.c_new_intensity_correction(ds, out, dither, flyr, layru, lyrcut, ncut, oprim, phasa, phast, phasm, phirad, tauc, taucpr, utaupr)
c_new_intensity_correction = _cdisort.c_new_intensity_correction

def prep_double_scat_integr(nphase, ntau, nf, mu_phase, phas2, mu_eq, neg_phas, norm_phas):
    return _cdisort.prep_double_scat_integr(nphase, ntau, nf, mu_phase, phas2, mu_eq, neg_phas, norm_phas)
prep_double_scat_integr = _cdisort.prep_double_scat_integr

def c_secondary_scat(ds, iu, lu, ctheta, flyr, layru, tauc):
    return _cdisort.c_secondary_scat(ds, iu, lu, ctheta, flyr, layru, tauc)
c_secondary_scat = _cdisort.c_secondary_scat

def c_new_secondary_scat(ds, iu, lu, it, ctheta, flyr, layru, tauc, nf, phas2, mu_eq, neg_phas, norm_phas):
    return _cdisort.c_new_secondary_scat(ds, iu, lu, it, ctheta, flyr, layru, tauc, nf, phas2, mu_eq, neg_phas, norm_phas)
c_new_secondary_scat = _cdisort.c_new_secondary_scat

def calc_phase_squared(nphase, lu, ctheta, nf, mu_phase, phas2, mu_eq, neg_phas, norm_phas):
    return _cdisort.calc_phase_squared(nphase, lu, ctheta, nf, mu_phase, phas2, mu_eq, neg_phas, norm_phas)
calc_phase_squared = _cdisort.calc_phase_squared

def c_disort_set(ds, ch, chtau, cmu, cwt, deltam, dtaucpr, expbea, flyr, gl, layru, lyrcut, ncut, nn, corint, oprim, tauc, taucpr, utaupr):
    return _cdisort.c_disort_set(ds, ch, chtau, cmu, cwt, deltam, dtaucpr, expbea, flyr, gl, layru, lyrcut, ncut, nn, corint, oprim, tauc, taucpr, utaupr)
c_disort_set = _cdisort.c_disort_set

def c_set_matrix(ds, bdr, cband, cmu, cwt, delm0, dtaucpr, gc, kk, lyrcut, ncol, ncut, taucpr, wk):
    return _cdisort.c_set_matrix(ds, bdr, cband, cmu, cwt, delm0, dtaucpr, gc, kk, lyrcut, ncol, ncut, taucpr, wk)
c_set_matrix = _cdisort.c_set_matrix

def c_single_scat(dither, layru, nlyr, phase, omega, tau, umu, umu0, utau, fbeam):
    return _cdisort.c_single_scat(dither, layru, nlyr, phase, omega, tau, umu, umu0, utau, fbeam)
c_single_scat = _cdisort.c_single_scat

def c_solve_eigen(ds, lc, ab, array, cmu, cwt, gl, mazim, nn, ylmc, cc, evecc, eval, kk, gc, wk):
    return _cdisort.c_solve_eigen(ds, lc, ab, array, cmu, cwt, gl, mazim, nn, ylmc, cc, evecc, eval, kk, gc, wk)
c_solve_eigen = _cdisort.c_solve_eigen

def c_solve0(ds, b, bdr, bem, bplanck, cband, cmu, cwt, expbea, ipvt, ll, lyrcut, mazim, ncol, ncut, nn, tplanck, taucpr, z, zbeamsp, zbeama, zz, plk):
    return _cdisort.c_solve0(ds, b, bdr, bem, bplanck, cband, cmu, cwt, expbea, ipvt, ll, lyrcut, mazim, ncol, ncut, nn, tplanck, taucpr, z, zbeamsp, zbeama, zz, plk)
c_solve0 = _cdisort.c_solve0

def c_surface_bidir(ds, delm0, cmu, mazim, nn, bdr, emu, bem, rmu, callnum):
    return _cdisort.c_surface_bidir(ds, delm0, cmu, mazim, nn, bdr, emu, bem, rmu, callnum)
c_surface_bidir = _cdisort.c_surface_bidir

def c_interp_eigenvec(ds, lc, cwt, evecc, gl, gu, mazim, nn, wk, ylmc, ylmu):
    return _cdisort.c_interp_eigenvec(ds, lc, cwt, evecc, gl, gu, mazim, nn, wk, ylmc, ylmu)
c_interp_eigenvec = _cdisort.c_interp_eigenvec

def c_interp_source(ds, lc, cwt, delm0, gl, mazim, oprim, ylm0, ylmc, ylmu, psi, xr, zee, zj, zbeam, zbu, zbs, zbsa, zu):
    return _cdisort.c_interp_source(ds, lc, cwt, delm0, gl, mazim, oprim, ylm0, ylmc, ylmu, psi, xr, zee, zj, zbeam, zbu, zbs, zbsa, zu)
c_interp_source = _cdisort.c_interp_source

def c_set_coefficients_beam_source(ds, ch, chtau, cmu, delm0, fbeam, gl, lc, mazim, nstr, taucpr, xba, xb, ylm0, ylmc, zj):
    return _cdisort.c_set_coefficients_beam_source(ds, ch, chtau, cmu, delm0, fbeam, gl, lc, mazim, nstr, taucpr, xba, xb, ylm0, ylmc, zj)
c_set_coefficients_beam_source = _cdisort.c_set_coefficients_beam_source

def c_interp_coefficients_beam_source(ds, chtau, delm0, fbeam, gl, lc, mazim, nstr, numu, taucpr, zbu, xba, zj, ylm0, ylmu):
    return _cdisort.c_interp_coefficients_beam_source(ds, chtau, delm0, fbeam, gl, lc, mazim, nstr, numu, taucpr, zbu, xba, zj, ylm0, ylmu)
c_interp_coefficients_beam_source = _cdisort.c_interp_coefficients_beam_source

def c_upbeam_pseudo_spherical(ds, lc, array, cc, cmu, ipvt, nn, wk, xb, xba, zbs, zbsa, zbeamsp, zbeama):
    return _cdisort.c_upbeam_pseudo_spherical(ds, lc, array, cc, cmu, ipvt, nn, wk, xb, xba, zbs, zbsa, zbeamsp, zbeama)
c_upbeam_pseudo_spherical = _cdisort.c_upbeam_pseudo_spherical

def c_upbeam(ds, lc, array, cc, cmu, delm0, gl, ipvt, mazim, nn, wk, ylm0, ylmc, zj, zz):
    return _cdisort.c_upbeam(ds, lc, array, cc, cmu, delm0, gl, ipvt, mazim, nn, wk, ylm0, ylmc, zj, zz)
c_upbeam = _cdisort.c_upbeam

def c_upisot(ds, lc, array, cc, cmu, ipvt, nn, oprim, wk, xr, zee, plk):
    return _cdisort.c_upisot(ds, lc, array, cc, cmu, ipvt, nn, oprim, wk, xr, zee, plk)
c_upisot = _cdisort.c_upisot

def c_user_intensities(ds, bplanck, cmu, cwt, delm0, dtaucpr, emu, expbea, gc, gu, kk, layru, ll, lyrcut, mazim, ncut, nn, rmu, taucpr, tplanck, utaupr, wk, zbu, zbeam, zbeamsp, zbeama, zu, zz, plk, uum):
    return _cdisort.c_user_intensities(ds, bplanck, cmu, cwt, delm0, dtaucpr, emu, expbea, gc, gu, kk, layru, ll, lyrcut, mazim, ncut, nn, rmu, taucpr, tplanck, utaupr, wk, zbu, zbeam, zbeamsp, zbeama, zu, zz, plk, uum)
c_user_intensities = _cdisort.c_user_intensities

def c_xi_func(umu1, umu2, tau):
    return _cdisort.c_xi_func(umu1, umu2, tau)
c_xi_func = _cdisort.c_xi_func

def c_check_inputs(ds, scat_yes, deltam, corint, tauc, callnum):
    return _cdisort.c_check_inputs(ds, scat_yes, deltam, corint, tauc, callnum)
c_check_inputs = _cdisort.c_check_inputs

def c_legendre_poly(nmu, m, maxmu, twonm1, mu, ylm):
    return _cdisort.c_legendre_poly(nmu, m, maxmu, twonm1, mu, ylm)
c_legendre_poly = _cdisort.c_legendre_poly

def c_print_avg_intensities(ds, out):
    return _cdisort.c_print_avg_intensities(ds, out)
c_print_avg_intensities = _cdisort.c_print_avg_intensities

def c_print_inputs(ds, dtaucpr, scat_yes, deltam, corint, flyr, lyrcut, oprim, tauc, taucpr):
    return _cdisort.c_print_inputs(ds, dtaucpr, scat_yes, deltam, corint, flyr, lyrcut, oprim, tauc, taucpr)
c_print_inputs = _cdisort.c_print_inputs

def c_print_intensities(ds, out):
    return _cdisort.c_print_intensities(ds, out)
c_print_intensities = _cdisort.c_print_intensities

def c_gaussian_quadrature(m, gmu, gwt):
    return _cdisort.c_gaussian_quadrature(m, gmu, gwt)
c_gaussian_quadrature = _cdisort.c_gaussian_quadrature

def c_ratio(a, b):
    return _cdisort.c_ratio(a, b)
c_ratio = _cdisort.c_ratio

def c_fcmp(x1, x2):
    return _cdisort.c_fcmp(x1, x2)
c_fcmp = _cdisort.c_fcmp

def c_self_test(compare, prntu0, ds, out):
    return _cdisort.c_self_test(compare, prntu0, ds, out)
c_self_test = _cdisort.c_self_test

def c_albtrans(ds, out, ab, array, b, bdr, cband, cc, cmu, cwt, dtaucpr, eval, evecc, gl, gc, gu, ipvt, kk, ll, nn, taucpr, ylmc, ylmu, z, wk):
    return _cdisort.c_albtrans(ds, out, ab, array, b, bdr, cband, cc, cmu, cwt, dtaucpr, eval, evecc, gl, gc, gu, ipvt, kk, ll, nn, taucpr, ylmc, ylmu, z, wk)
c_albtrans = _cdisort.c_albtrans

def c_albtrans_intensity(ds, out, gu, kk, ll, nn, taucpr, wk):
    return _cdisort.c_albtrans_intensity(ds, out, gu, kk, ll, nn, taucpr, wk)
c_albtrans_intensity = _cdisort.c_albtrans_intensity

def c_print_albtrans(ds, out):
    return _cdisort.c_print_albtrans(ds, out)
c_print_albtrans = _cdisort.c_print_albtrans

def c_solve1(ds, cband, ihom, ipvt, ncol, ncut, nn, b, ll):
    return _cdisort.c_solve1(ds, cband, ihom, ipvt, ncol, ncut, nn, b, ll)
c_solve1 = _cdisort.c_solve1

def c_albtrans_spherical(ds, cmu, cwt, gc, kk, ll, nn, taucpr, sflup, sfldn):
    return _cdisort.c_albtrans_spherical(ds, cmu, cwt, gc, kk, ll, nn, taucpr, sflup, sfldn)
c_albtrans_spherical = _cdisort.c_albtrans_spherical

def c_errmsg(messag, type):
    return _cdisort.c_errmsg(messag, type)
c_errmsg = _cdisort.c_errmsg

def c_write_bad_var(quiet, varnam):
    return _cdisort.c_write_bad_var(quiet, varnam)
c_write_bad_var = _cdisort.c_write_bad_var

def c_write_too_small_dim(quiet, dimnam, minval):
    return _cdisort.c_write_too_small_dim(quiet, dimnam, minval)
c_write_too_small_dim = _cdisort.c_write_too_small_dim

def c_sgbco(abd, lda, n, ml, mu, ipvt, rcond, z):
    return _cdisort.c_sgbco(abd, lda, n, ml, mu, ipvt, rcond, z)
c_sgbco = _cdisort.c_sgbco

def c_sgbfa(abd, lda, n, ml, mu, ipvt, info):
    return _cdisort.c_sgbfa(abd, lda, n, ml, mu, ipvt, info)
c_sgbfa = _cdisort.c_sgbfa

def c_sgbsl(abd, lda, n, ml, mu, ipvt, b, job):
    return _cdisort.c_sgbsl(abd, lda, n, ml, mu, ipvt, b, job)
c_sgbsl = _cdisort.c_sgbsl

def c_sgeco(a, lda, n, ipvt, rcond, z):
    return _cdisort.c_sgeco(a, lda, n, ipvt, rcond, z)
c_sgeco = _cdisort.c_sgeco

def c_sgefa(a, lda, n, ipvt, info):
    return _cdisort.c_sgefa(a, lda, n, ipvt, info)
c_sgefa = _cdisort.c_sgefa

def c_sgesl(a, lda, n, ipvt, b, job):
    return _cdisort.c_sgesl(a, lda, n, ipvt, b, job)
c_sgesl = _cdisort.c_sgesl

def c_sasum(n, sx):
    return _cdisort.c_sasum(n, sx)
c_sasum = _cdisort.c_sasum

def c_saxpy(n, sa, sx, sy):
    return _cdisort.c_saxpy(n, sa, sx, sy)
c_saxpy = _cdisort.c_saxpy

def c_sdot(n, sx, sy):
    return _cdisort.c_sdot(n, sx, sy)
c_sdot = _cdisort.c_sdot

def c_sscal(n, sa, sx):
    return _cdisort.c_sscal(n, sa, sx)
c_sscal = _cdisort.c_sscal

def c_isamax(n, sx):
    return _cdisort.c_isamax(n, sx)
c_isamax = _cdisort.c_isamax

def c_twostr(ds, out, deltam, gg, ierror, radius):
    return _cdisort.c_twostr(ds, out, deltam, gg, ierror, radius)
c_twostr = _cdisort.c_twostr

def c_chapman(lc, taup, tauc, nlyr, zd, dtau_c, zenang, r):
    return _cdisort.c_chapman(lc, taup, tauc, nlyr, zd, dtau_c, zenang, r)
c_chapman = _cdisort.c_chapman

def c_twostr_check_inputs(ds, gg, ierror, tauc):
    return _cdisort.c_twostr_check_inputs(ds, gg, ierror, tauc)
c_twostr_check_inputs = _cdisort.c_twostr_check_inputs

def c_twostr_fluxes(ds, ts, ch, cmu, kk, layru, ll, lyrcut, ncut, oprim, rr, taucpr, utaupr, out, u0c, fl):
    return _cdisort.c_twostr_fluxes(ds, ts, ch, cmu, kk, layru, ll, lyrcut, ncut, oprim, rr, taucpr, utaupr, out, u0c, fl)
c_twostr_fluxes = _cdisort.c_twostr_fluxes

def c_twostr_solns(ds, ch, chtau, cmu, ncut, oprim, pkag, pkagc, taucpr, ggprim, kk, rr, ts):
    return _cdisort.c_twostr_solns(ds, ch, chtau, cmu, ncut, oprim, pkag, pkagc, taucpr, ggprim, kk, rr, ts)
c_twostr_solns = _cdisort.c_twostr_solns

def c_twostr_print_inputs(ds, deltam, flyr, gg, lyrcut, oprim, tauc, taucpr):
    return _cdisort.c_twostr_print_inputs(ds, deltam, flyr, gg, lyrcut, oprim, tauc, taucpr)
c_twostr_print_inputs = _cdisort.c_twostr_print_inputs

def c_twostr_set(ds, bplanck, ch, chtau, cmu, deltam, dtaucpr, expbea, flyr, gg, ggprim, layru, lyrcut, ncut, nn, oprim, pkag, pkagc, radius, tauc, taucpr, tplanck, utaupr):
    return _cdisort.c_twostr_set(ds, bplanck, ch, chtau, cmu, deltam, dtaucpr, expbea, flyr, gg, ggprim, layru, lyrcut, ncut, nn, oprim, pkag, pkagc, radius, tauc, taucpr, tplanck, utaupr)
c_twostr_set = _cdisort.c_twostr_set

def c_twostr_solve_bc(ds, ts, bplanck, cband, cmu, expbea, lyrcut, nn, ncut, tplanck, taucpr, kk, rr, ipvt, b, ll, diag):
    return _cdisort.c_twostr_solve_bc(ds, ts, bplanck, cband, cmu, expbea, lyrcut, nn, ncut, tplanck, taucpr, kk, rr, ipvt, b, ll, diag)
c_twostr_solve_bc = _cdisort.c_twostr_solve_bc

def c_planck_func1(wnumlo, wnumhi, t):
    return _cdisort.c_planck_func1(wnumlo, wnumhi, t)
c_planck_func1 = _cdisort.c_planck_func1

def c_planck_func2(wnumlo, wnumhi, t):
    return _cdisort.c_planck_func2(wnumlo, wnumhi, t)
c_planck_func2 = _cdisort.c_planck_func2

def c_disort_state_alloc(ds):
    return _cdisort.c_disort_state_alloc(ds)
c_disort_state_alloc = _cdisort.c_disort_state_alloc

def c_disort_state_free(ds):
    return _cdisort.c_disort_state_free(ds)
c_disort_state_free = _cdisort.c_disort_state_free

def c_disort_out_alloc(ds, out):
    return _cdisort.c_disort_out_alloc(ds, out)
c_disort_out_alloc = _cdisort.c_disort_out_alloc

def c_disort_out_free(ds, out):
    return _cdisort.c_disort_out_free(ds, out)
c_disort_out_free = _cdisort.c_disort_out_free

def c_twostr_state_alloc(ds):
    return _cdisort.c_twostr_state_alloc(ds)
c_twostr_state_alloc = _cdisort.c_twostr_state_alloc

def c_twostr_state_free(ds):
    return _cdisort.c_twostr_state_free(ds)
c_twostr_state_free = _cdisort.c_twostr_state_free

def c_twostr_out_alloc(ds, out):
    return _cdisort.c_twostr_out_alloc(ds, out)
c_twostr_out_alloc = _cdisort.c_twostr_out_alloc

def c_twostr_out_free(ds, out):
    return _cdisort.c_twostr_out_free(ds, out)
c_twostr_out_free = _cdisort.c_twostr_out_free

def c_dbl_vector(nl, nh, name):
    return _cdisort.c_dbl_vector(nl, nh, name)
c_dbl_vector = _cdisort.c_dbl_vector

def c_int_vector(nl, nh, name):
    return _cdisort.c_int_vector(nl, nh, name)
c_int_vector = _cdisort.c_int_vector

def print_test(ds_calc, calc, ds_good, good):
    return _cdisort.print_test(ds_calc, calc, ds_good, good)
print_test = _cdisort.print_test

def c_free_dbl_vector(m, nl, nh):
    return _cdisort.c_free_dbl_vector(m, nl, nh)
c_free_dbl_vector = _cdisort.c_free_dbl_vector

def c_setout(sdtauc, nlyr, ntau, sutau, z, zout):
    return _cdisort.c_setout(sdtauc, nlyr, ntau, sutau, z, zout)
c_setout = _cdisort.c_setout

def c_inter(npoints, itype, arg, xarr, yarr, hh):
    return _cdisort.c_inter(npoints, itype, arg, xarr, yarr, hh)
c_inter = _cdisort.c_inter

def c_gaussian_quadrature_test(nstr, sza, umu0):
    return _cdisort.c_gaussian_quadrature_test(nstr, sza, umu0)
...
def locate(xx, n, x):
    return _cdisort.locate(xx, n, x)
locate = _cdisort.locate

def flocate(xx, n, x):
    return _cdisort.flocate(xx, n, x)
